...
export default function Navbar() {
    return (
        <header className="flex justify-between items-center max-w-[1920px] m-auto px-4 md:px-8 lg:px-32 h-20 sticky top-0 bg-white/90">
            <nav className="flex items-center justify-between w-full">
                ...
                <label htmlFor="mobile-menu" className="relative z-40 cursor-pointer px-3 py-6 lg:hidden">
