...
export default function Hero() {
    return (
        <main className="flex flex-col gap-5 justify-center items-center h-[calc(100vh-80px)] mx-auto max-w-[1920px] max-h-[992px] snap-start px-4 md:px-8 md:max-w-xl lg:gap-20 lg:px-32 lg:flex-row lg:max-w-none">
            ...
            <Image src={HeroImage} alt="Hero Image" width={264} className="rounded-lg w-72 lg:flex-1 lg:w-auto lg:max-w-lg drop-shadow-xl" />
        </main>
    )
}
