...
export default function HowCostumersUsing() {
    return (
        <section id="costumers-using" className="flex flex-col gap-8 items-center justify-center text-center w-full h-full my-10 px-4 snap-start md:my-20 md:px-8 lg:px-32">
            <h2 className="text-3xl font-semibold">How Customers are using <span className="font-bold">Classcript</span>?</h2>
